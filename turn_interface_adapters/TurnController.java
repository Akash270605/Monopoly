...
public class TurnController {
    ...
    //Set the input boundaries to use in this controller
    public void initializeAttributes(GameState gameState, BuildBuildingInputBoundary buildBuilding,
    ...
    //Signifies the end of a use case 
